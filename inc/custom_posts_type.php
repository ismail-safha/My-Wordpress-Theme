...
function clients_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'clients post type', 'text_domain' ),
		'labels'                => $labels,
...
function services_post_type() {
	...
	$args = array(
		...
		'description'           => __( 'services post type', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
function portfolio_post_type() {
	...
	$labels = array(
		...
		'singular_name'         => _x( 'Portfolios', 'Post Type Singular Name', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'portfolios Type Description', 'text_domain' ),
		'labels'                => $labels,
...
function teams_post_type() {
	...
	$labels = array(
		...
		'singular_name'         => _x( 'Teams', 'Post Type Singular Name', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Teams Post Type', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
